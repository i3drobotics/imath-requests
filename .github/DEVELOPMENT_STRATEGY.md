...
2. Create a new branch from the 'main' branch with the issue number and a 3 letter project prefix (IMR for imath requests) in format IMR-### e.g. IMR-22. Alternatively the branch can have a short descriptive name prefix e.g. an issue that adds tests for a function 'foo' could be called 'add-foo-tests-22'. 
